...
function NfluenceApp() {
  const [view, setView] = useState("brandprofile"); // landing | builder | browse | detail | brandprofile | signin | dashboard | messages | inbox | onboarding | reviews
      ...
      <div style={{ width: "100%", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 32px", textShadow: "0 1px 3px rgba(0,0,0,.35)", fontFamily: "'Monda', system-ui, sans-serif" }}>
        ...
        <div style={{ display: "flex", gap: 18, fontSize: ".9rem", opacity: .85 }}>
          ...
          {user ? (
            ...
            <span style={{ color: "#fff", cursor: "pointer", borderLeft: "1px solid rgba(255,255,255,.2)", paddingLeft: 18 }} onClick={() => setView("creatordashboard")}>my dashboard</span>
          ) : (
