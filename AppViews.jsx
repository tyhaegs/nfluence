                ...
                <div key={c.id || i} className="nf-campaign-card" style={{ position: "relative" }} onClick={() => onSelectCampaign(c)}>
                  ...
                  <div style={{ padding: "12px 16px 0", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                    ...
                    <div style={{ textAlign: "right", flexShrink: 0 }}>
                      <div style={{ background: "rgba(255,255,255,.06)", border: "1px solid rgba(255,255,255,.1)", borderRadius: 10, padding: "6px 12px", fontSize: ".85rem", color: "#fff", fontWeight: 600, whiteSpace: "nowrap", display: "inline-block" }}>
                    ...
                    <div style={{ flex: 1 }}>
                      {c.deadline && (
                        <div style={{ fontSize: ".82rem", opacity: .4, marginBottom: 4 }}>deadline {c.deadline}</div>
                      )}
                    </div>
                    {/* Footer */}
